...
from classify.train import main as train_main
from classify.train import parse_opt

if __name__ == "__main__":
    # Arguments par défaut
    opt = parse_opt()
    opt.model = "yolov5s-cls.pt"
    opt.data = str(yolov5_root / "dataset_oiseaux")  # Utilize directement le dossier, pas le YAML
    opt.epochs = 30
    opt.img = 224
    opt.batch_size = 32
    opt.device = "0"
