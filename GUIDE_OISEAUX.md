...
Les deux seuils sont à ajuster selon les essais; pour démarrer, une base pratique est `BDD >= 0.60` et `incertitude >= 0.50`, soit 60 % pour BDD et 50 % pour l'incertitude.
