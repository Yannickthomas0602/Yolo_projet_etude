# Project Oiseaux — YOLOv5

Description

- Ce répertoire contient une adaptation locale de YOLOv5 dédiée à l'analyse et la classification d'oiseaux, avec les scripts d'entraînement, d'inférence et la documentation spécifique au project. Ce project a un but éducatif et pédagogique uniquement, et n'a pas vocation à être commercialisé ni produit à grande échelle.

Contexte et documentation essentielle

- [01_GUIDE_OISEAUX.md](01_GUIDE_OISEAUX.md) — Guide d'utilisation spécifique au project oiseaux
...
- Ce project s'accompagne d'un livrable décrivant le déroulé complete du travail réalisé :
...
- 3. Conception d'une solution technique pour réduire les attaques (stratégies de détection/alerte et measures de protection).
...
- Le livrable contient le rapport de recherche, les choix techniques, les jeux de données utilisés et les premiers résultats d'entraînement. Il accompagne le project et peut être livré dans un dossier `livrable/` ou via une release GitHub selon votre préférence.
...
Examples rapides (depuis ce répertoire)
